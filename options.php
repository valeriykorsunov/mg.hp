...
if($RIGHT_W) {
    $aTabs = array(
        ...
        array("DIV" => "edit3", "TAB" => "Доступ", "ICON" => "", "TITLE" => "Настройки доступа"),
    ...
    <form method="post" action="<? echo $APPLICATION->GetCurPage() ?>?&lang=<?= LANGUAGE_ID ?>&mid=mg.hp"
        ...
        <tr>
            <td>
                ...
                <div style="padding-top: 10px;">
                    <a href="javascript:void(0)" data-tabname="Новая вкладка" data-tabid="new" onclick="editTab(this);">Добавить
                        вкладку</a>
                </div>
            </td>
        </tr>
