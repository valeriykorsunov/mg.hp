...
define('ASD_UT_CHECKBOX', 'HPCheckbox');
...
class CIBlockPropertyCheckbox
{
	public static function GetUserTypeDescription()
	{
		return array(
			...
			'DESCRIPTION' => 'Простой чекбокс - строка (HELPER)',
...
?><tr>
		...
		<tr>
			...
			public static function GetAdminFilterHTML($arProperty, $strHTMLControlName)
			{
				...
				$strResult .= '<option value=""' . (empty($strCurValue) ? ' selected="selected"' : '') . '>' . htmlspecialcharsex('любое') . '</option>';
			...
			{
				return array(
					ASD_UT_CHECKBOX_VAL_FALSE => 'N',
					ASD_UT_CHECKBOX_VAL_TRUE => 'Y'
				);
			}
		}
